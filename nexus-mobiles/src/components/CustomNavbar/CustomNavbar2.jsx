	...
	return (
		<ul className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
			<Typography
				as="li"
				variant="small"
				className="p-1 font-bold text-base md:text-xl"
			>
				<a
					href="#"
					className="flex items-center hover:text-[var(--primary-color-dark)] transition-colors"
				>
					Pages
				</a>
			</Typography>
...
const CustomNavbar = () => {
	...
	return (
		<div className="">
			<Navbar className="container font-alegreya bg-[var(--white)] px-6 py-3 shadow-none text-[var(--primary-color)]">
				<div className="flex items-center justify-between ">
					...
					<div className="flex items-center gap-4">
						...
						<div className="flex items-center gap-4">
							<IconButton
								variant="text"
								className="ml-auto h-6 w-6 text-[var(--primary-color)] hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
								ripple={false}
								onClick={() => setOpenNav(!openNav)}
							>
								{openNav ? <FaXmark size={24} /> : <FaBars size={24} />}
							</IconButton>
				...
				{openNav ? (
					<Collapse open={openNav} className="bg-gray-50 mt-4 rounded-lg p-2">
						<NavList />
					</Collapse>
				) : (
					<></>
